...
# Script para deploy da Cloud Function de geração sintética

echo "🤖 Deploy da Cloud Function de Geração Sintética"
echo "==============================================="

# Configurar projeto
PROJECT_ID="automatizar-452311"
FUNCTION_NAME="generate-synthetic-data"
...
gcloud functions deploy $FUNCTION_NAME \
    ...
    --region $REGION \
    --source . \
    --entry-point generate_synthetic_data \
    --memory 256MB \
    --timeout 300s
